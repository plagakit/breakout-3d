...
//{
//	m_registry.ParallelForAll<Ball, Transform2D, CircleCollider>(
//		[](auto item)
//		{
//			auto [id, ball, tf, col] = item;
//			if (tf.position.x - col.radius < 0 || tf.position.x + col.radius > Game::SCREEN_WIDTH)
//				tf.velocity.x *= -1;
//
//			if (tf.position.y - col.radius < 0 || tf.position.y + col.radius > Game::SCREEN_HEIGHT)
//				tf.velocity.y *= -1;
//		}
//	);
//}
